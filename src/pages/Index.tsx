      ...
      <div className="container mx-auto flex h-16 items-center justify-between">
        ...
        <Link to="/" className="flex items-center gap-2">
          ...
          <div className="flex flex-col leading-none ml-2">
            <span className="font-display text-sm font-bold text-foreground">HIRE</span>
            <span className="font-display text-xs font-semibold text-foreground/80 tracking-widest">MIND</span>
          </div>
        </Link>
    ...
    <div className="container mx-auto flex flex-col items-center gap-6 px-6 text-center text-sm">
      <div className="flex items-center gap-2">
        <div className="flex flex-col leading-none ml-2 text-left">
          <span className="font-display text-sm font-bold text-slate-800">HIRE</span>
          <span className="font-display text-xs font-semibold text-slate-500 tracking-widest">MIND</span>
        </div>
      </div>
      ...
      <p className="text-slate-400 text-xs mt-4">© 2026 HireMind. All rights reserved.</p>
    </div>
  </footer>
);
