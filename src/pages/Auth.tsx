...
import { Mail, Lock, User, ArrowRight, Github, Star } from "lucide-react";
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                  ...
                  <NeuButton variant="primary" className="w-full py-4 mt-6 text-sm flex items-center justify-center gap-2">
                ...
                <div className="mt-6 grid grid-cols-2 gap-4">
                  <NeuButton variant="default" className="w-full py-3 flex items-center justify-center gap-2">
